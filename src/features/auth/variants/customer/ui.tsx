...
export function CustomerLoginUI() {
  ...
  const { customerLogin, isLoading, error } = useCustomerAuth();
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <div className="flex items-center justify-between text-sm">
          ...
          <Link
            ...
            className="font-medium text-green-600 hover:text-green-800 bg-transparent border-none cursor-pointer p-0"
          >
            Lupa password?
          </Link>
        </div>
        ...
        <Button 
          type="submit" 
          className="w-full text-white bg-green-600 hover:bg-green-700 font-bold h-12 rounded-md text-sm"
          disabled={isLoading}
        >
