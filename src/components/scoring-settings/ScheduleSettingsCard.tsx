...
export default function ScheduleSettingsCard({ eventId }: Readonly<ScheduleSettingsCardProps>) {
  ...
  // Function to save schedule settings to the server
  const handleSaveSettings = () => {
    // Here we use the eventId prop
    console.log(`Saving schedule settings for event: ${eventId}`, schedules);
    alert(`Schedule settings for event ${eventId} saved successfully!`);
  };
  ...
  return (
    <Card>
      ...
      <CardContent className="space-y-6">
        ...
        {/* Add a button to save schedule settings */}
        <div className="flex justify-end pt-4 border-t">
          <Button onClick={handleSaveSettings} className="bg-green-600 hover:bg-green-700">
            <Save size={16} className="mr-2" /> Simpan Pengaturan Jadwal
          </Button>
        </div>
      </CardContent>
    </Card>
